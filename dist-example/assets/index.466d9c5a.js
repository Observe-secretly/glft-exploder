...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:zi,depthTest:!1,depthWrite:!1})}function Jm(r,e,t){const i=new Float32Array(pn),n=new w(0,1,0);return new Ci({name:"SphericalGaussianBlur",defines:{n:pn,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:n}},vertexShader:zr(),fragmentShader:`
		...
		`,blending:zi,depthTest:!1,depthWrite:!1})}function cc(){return new Ci({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zr(),fragmentShader:`
		...
		`,blending:zi,depthTest:!1,depthWrite:!1})}function hc(){return new Ci({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zr(),fragmentShader:`
		...
		`,blending:zi,depthTest:!1,depthWrite:!1})}function zr(){return`
...
`)}const n_={[Vc]:"Linear",[Hc]:"Reinhard",[Gc]:"Cineon",[Lo]:"ACESFilmic",[Xc]:"AgX",[jc]:"Neutral",[Wc]:"Custom"};function s_(r,e){const t=n_[e];return t===void 0?(be("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const xr=new w;function r_(){je.getLuminanceCoefficients(xr);const r=xr.x.toFixed(4),e=xr.y.toFixed(4),t=xr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Es).join(`
`)),a=wo(a),a=Mc(a,t),a=Sc(a,t),o=wo(o),o=Mc(o,t),o=Sc(o,t),a=yc(a),o=yc(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
